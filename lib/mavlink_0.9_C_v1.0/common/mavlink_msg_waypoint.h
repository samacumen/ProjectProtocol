...
#define MAVLINK_MSG_ID_WAYPOINT_MIN_LEN 36
#define MAVLINK_MSG_ID_39_LEN 36
#define MAVLINK_MSG_ID_39_MIN_LEN 36

#define MAVLINK_MSG_ID_WAYPOINT_CRC 205
#define MAVLINK_MSG_ID_39_CRC 205
						       ...
						       uint8_t target_system, uint8_t target_component, uint16_t seq, uint8_t frame, uint8_t command, uint8_t current, uint8_t autocontinue, float param1, float param2, float param3, float param4, float x, float y, float z)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_WAYPOINT_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_LEN, MAVLINK_MSG_ID_WAYPOINT_CRC);
}
						           ...
						           uint8_t target_system,uint8_t target_component,uint16_t seq,uint8_t frame,uint8_t command,uint8_t current,uint8_t autocontinue,float param1,float param2,float param3,float param4,float x,float y,float z)
{
	...
	msg->msgid = MAVLINK_MSG_ID_WAYPOINT;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_WAYPOINT_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_LEN, MAVLINK_MSG_ID_WAYPOINT_CRC);
}
...
{
	return mavlink_msg_waypoint_pack_chan(system_id, component_id, chan, msg, waypoint->target_system, waypoint->target_component, waypoint->seq, waypoint->frame, waypoint->command, waypoint->current, waypoint->autocontinue, waypoint->param1, waypoint->param2, waypoint->param3, waypoint->param4, waypoint->x, waypoint->y, waypoint->z);
}
...
static inline void mavlink_msg_waypoint_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t seq, uint8_t frame, uint8_t command, uint8_t current, uint8_t autocontinue, float param1, float param2, float param3, float param4, float x, float y, float z)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT, buf, MAVLINK_MSG_ID_WAYPOINT_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_LEN, MAVLINK_MSG_ID_WAYPOINT_CRC);
#else
	mavlink_waypoint_t packet;
	packet.param1 = param1;
	packet.param2 = param2;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_LEN, MAVLINK_MSG_ID_WAYPOINT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_waypoint_send_struct(mavlink_channel_t chan, const mavlink_waypoint_t* waypoint)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_waypoint_send(chan, waypoint->target_system, waypoint->target_component, waypoint->seq, waypoint->frame, waypoint->command, waypoint->current, waypoint->autocontinue, waypoint->param1, waypoint->param2, waypoint->param3, waypoint->param4, waypoint->x, waypoint->y, waypoint->z);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT, (const char *)waypoint, MAVLINK_MSG_ID_WAYPOINT_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_LEN, MAVLINK_MSG_ID_WAYPOINT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_waypoint_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t seq, uint8_t frame, uint8_t command, uint8_t current, uint8_t autocontinue, float param1, float param2, float param3, float param4, float x, float y, float z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_WAYPOINT_LEN? msg->len : MAVLINK_MSG_ID_WAYPOINT_LEN;
        memset(waypoint, 0, MAVLINK_MSG_ID_WAYPOINT_LEN);
	memcpy(waypoint, _MAV_PAYLOAD(msg), len);
#endif
}
