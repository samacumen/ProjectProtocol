...
#define MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_MIN_LEN 14
#define MAVLINK_MSG_ID_252_LEN 14
#define MAVLINK_MSG_ID_252_MIN_LEN 14

#define MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_CRC 248
#define MAVLINK_MSG_ID_252_CRC 248
...
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_FLOAT { \
	...
	"NAMED_VALUE_FLOAT", \
	2, \
	{  { "value", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_named_value_float_t, value) }, \
         { "name", NULL, MAVLINK_TYPE_CHAR, 10, 4, offsetof(mavlink_named_value_float_t, name) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_FLOAT { \
...
{
	return mavlink_msg_named_value_float_pack_chan(system_id, component_id, chan, msg, named_value_float->name, named_value_float->value);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_named_value_float_send(chan, named_value_float->name, named_value_float->value);
#else
 ...
 */
static inline void mavlink_msg_named_value_float_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const char *name, float value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
