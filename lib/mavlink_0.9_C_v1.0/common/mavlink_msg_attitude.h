...
#define MAVLINK_MSG_ID_ATTITUDE_MIN_LEN 32
#define MAVLINK_MSG_ID_30_LEN 32
#define MAVLINK_MSG_ID_30_MIN_LEN 32

#define MAVLINK_MSG_ID_ATTITUDE_CRC 66
#define MAVLINK_MSG_ID_30_CRC 66
...
{
	return mavlink_msg_attitude_pack_chan(system_id, component_id, chan, msg, attitude->usec, attitude->roll, attitude->pitch, attitude->yaw, attitude->rollspeed, attitude->pitchspeed, attitude->yawspeed);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_attitude_send(chan, attitude->usec, attitude->roll, attitude->pitch, attitude->yaw, attitude->rollspeed, attitude->pitchspeed, attitude->yawspeed);
#else
 ...
 */
static inline void mavlink_msg_attitude_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t usec, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
