...
#define MAVLINK_MSG_ID_27_MIN_LEN 101

#define MAVLINK_MSG_ID_GPS_STATUS_CRC 110
#define MAVLINK_MSG_ID_27_CRC 110
 ...
 */
static inline void mavlink_msg_gps_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t satellites_visible, const int8_t *satellite_prn, const int8_t *satellite_used, const int8_t *satellite_elevation, const int8_t *satellite_azimuth, const int8_t *satellite_snr)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
