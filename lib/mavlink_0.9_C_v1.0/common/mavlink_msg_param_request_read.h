...
#define MAVLINK_MSG_ID_PARAM_REQUEST_READ_MIN_LEN 19
#define MAVLINK_MSG_ID_20_LEN 19
#define MAVLINK_MSG_ID_20_MIN_LEN 19

#define MAVLINK_MSG_ID_PARAM_REQUEST_READ_CRC 39
#define MAVLINK_MSG_ID_20_CRC 39
...
#define MAVLINK_MESSAGE_INFO_PARAM_REQUEST_READ { \
	...
	{  { "param_index", NULL, MAVLINK_TYPE_INT16_T, 0, 0, offsetof(mavlink_param_request_read_t, param_index) }, \
         ...
         { "param_id", NULL, MAVLINK_TYPE_INT8_T, 15, 4, offsetof(mavlink_param_request_read_t, param_id) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_REQUEST_READ { \
						       ...
						       uint8_t target_system, uint8_t target_component, const int8_t *param_id, int16_t param_index)
{
	...
	_mav_put_int8_t_array(buf, 4, param_id, 15);
 ...
 */
static inline void mavlink_msg_param_request_read_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, const int8_t *param_id, int16_t param_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
	return _MAV_RETURN_int8_t_array(msg, param_id, 15,  4);
}
