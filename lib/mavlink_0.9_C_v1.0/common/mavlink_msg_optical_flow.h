...
#define MAVLINK_MSG_ID_OPTICAL_FLOW_MIN_LEN 18
#define MAVLINK_MSG_ID_100_LEN 18
#define MAVLINK_MSG_ID_100_MIN_LEN 18

#define MAVLINK_MSG_ID_OPTICAL_FLOW_CRC 146
#define MAVLINK_MSG_ID_100_CRC 146
...
{
	return mavlink_msg_optical_flow_pack_chan(system_id, component_id, chan, msg, optical_flow->time, optical_flow->sensor_id, optical_flow->flow_x, optical_flow->flow_y, optical_flow->quality, optical_flow->ground_distance);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_optical_flow_send(chan, optical_flow->time, optical_flow->sensor_id, optical_flow->flow_x, optical_flow->flow_y, optical_flow->quality, optical_flow->ground_distance);
#else
 ...
 */
static inline void mavlink_msg_optical_flow_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time, uint8_t sensor_id, int16_t flow_x, int16_t flow_y, uint8_t quality, float ground_distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
