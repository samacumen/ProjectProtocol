...
#define MAVLINK_MSG_ID_WAYPOINT_REQUEST_MIN_LEN 4
#define MAVLINK_MSG_ID_40_LEN 4
#define MAVLINK_MSG_ID_40_MIN_LEN 4

#define MAVLINK_MSG_ID_WAYPOINT_REQUEST_CRC 51
#define MAVLINK_MSG_ID_40_CRC 51
						       ...
						       uint8_t target_system, uint8_t target_component, uint16_t seq)
{
	...
	_mav_put_uint8_t(buf, 3, target_component);
        ...
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), buf, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN);
#else
	...
	packet.target_component = target_component;
        ...
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), &packet, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN);
#endif

	msg->msgid = MAVLINK_MSG_ID_WAYPOINT_REQUEST;
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_WAYPOINT_REQUEST_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_CRC);
}
						           ...
						           uint8_t target_system,uint8_t target_component,uint16_t seq)
{
	...
	msg->msgid = MAVLINK_MSG_ID_WAYPOINT_REQUEST;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_CRC);
}

/**
 * @brief Encode a waypoint_request struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
...
/**
 * @brief Encode a waypoint_request struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
 ...
 * @param waypoint_request C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_waypoint_request_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_waypoint_request_t* waypoint_request)
{
	return mavlink_msg_waypoint_request_pack_chan(system_id, component_id, chan, msg, waypoint_request->target_system, waypoint_request->target_component, waypoint_request->seq);
}
...
static inline void mavlink_msg_waypoint_request_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t seq)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST, buf, MAVLINK_MSG_ID_WAYPOINT_REQUEST_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_CRC);
#else
	mavlink_waypoint_request_t packet;
	packet.seq = seq;
	packet.target_system = target_system;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_REQUEST_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_waypoint_request_send_struct(mavlink_channel_t chan, const mavlink_waypoint_request_t* waypoint_request)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_waypoint_request_send(chan, waypoint_request->target_system, waypoint_request->target_component, waypoint_request->seq);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST, (const char *)waypoint_request, MAVLINK_MSG_ID_WAYPOINT_REQUEST_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_CRC);
#endif
}

#if MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
 ...
 */
static inline void mavlink_msg_waypoint_request_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t seq)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST, buf, MAVLINK_MSG_ID_WAYPOINT_REQUEST_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_CRC);
#else
	mavlink_waypoint_request_t *packet = (mavlink_waypoint_request_t *)msgbuf;
	packet->seq = seq;
	packet->target_system = target_system;
	packet->target_component = target_component;
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN? msg->len : MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN;
        memset(waypoint_request, 0, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN);
	memcpy(waypoint_request, _MAV_PAYLOAD(msg), len);
#endif
}
