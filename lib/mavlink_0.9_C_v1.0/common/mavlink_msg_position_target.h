...
#define MAVLINK_MSG_ID_POSITION_TARGET_MIN_LEN 16
#define MAVLINK_MSG_ID_63_LEN 16
#define MAVLINK_MSG_ID_63_MIN_LEN 16
						       ...
						       float x, float y, float z, float yaw)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_POSITION_TARGET_MIN_LEN, MAVLINK_MSG_ID_POSITION_TARGET_LEN, MAVLINK_MSG_ID_POSITION_TARGET_CRC);
}
						           ...
						           float x,float y,float z,float yaw)
{
	...
	msg->msgid = MAVLINK_MSG_ID_POSITION_TARGET;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_POSITION_TARGET_MIN_LEN, MAVLINK_MSG_ID_POSITION_TARGET_LEN, MAVLINK_MSG_ID_POSITION_TARGET_CRC);
}
...
static inline void mavlink_msg_position_target_send(mavlink_channel_t chan, float x, float y, float z, float yaw)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_TARGET, buf, MAVLINK_MSG_ID_POSITION_TARGET_MIN_LEN, MAVLINK_MSG_ID_POSITION_TARGET_LEN, MAVLINK_MSG_ID_POSITION_TARGET_CRC);
#else
	mavlink_position_target_t packet;
	packet.x = x;
	packet.y = y;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_TARGET, (const char *)&packet, MAVLINK_MSG_ID_POSITION_TARGET_MIN_LEN, MAVLINK_MSG_ID_POSITION_TARGET_LEN, MAVLINK_MSG_ID_POSITION_TARGET_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_position_target_send_struct(mavlink_channel_t chan, const mavlink_position_target_t* position_target)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_position_target_send(chan, position_target->x, position_target->y, position_target->z, position_target->yaw);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_TARGET, (const char *)position_target, MAVLINK_MSG_ID_POSITION_TARGET_MIN_LEN, MAVLINK_MSG_ID_POSITION_TARGET_LEN, MAVLINK_MSG_ID_POSITION_TARGET_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_POSITION_TARGET_LEN? msg->len : MAVLINK_MSG_ID_POSITION_TARGET_LEN;
        memset(position_target, 0, MAVLINK_MSG_ID_POSITION_TARGET_LEN);
	memcpy(position_target, _MAV_PAYLOAD(msg), len);
#endif
}
