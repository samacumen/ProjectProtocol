...
#define MAVLINK_MSG_ID_HIL_CONTROLS_MIN_LEN 26
#define MAVLINK_MSG_ID_68_LEN 26
#define MAVLINK_MSG_ID_68_MIN_LEN 26

#define MAVLINK_MSG_ID_HIL_CONTROLS_CRC 236
#define MAVLINK_MSG_ID_68_CRC 236
...
{
	return mavlink_msg_hil_controls_pack_chan(system_id, component_id, chan, msg, hil_controls->time_us, hil_controls->roll_ailerons, hil_controls->pitch_elevator, hil_controls->yaw_rudder, hil_controls->throttle, hil_controls->mode, hil_controls->nav_mode);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_hil_controls_send(chan, hil_controls->time_us, hil_controls->roll_ailerons, hil_controls->pitch_elevator, hil_controls->yaw_rudder, hil_controls->throttle, hil_controls->mode, hil_controls->nav_mode);
#else
 ...
 */
static inline void mavlink_msg_hil_controls_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_us, float roll_ailerons, float pitch_elevator, float yaw_rudder, float throttle, uint8_t mode, uint8_t nav_mode)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
