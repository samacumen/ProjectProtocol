...
public class msg_uavionix_adsb_out_cfg extends MAVLinkMessage{
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_UAVIONIX_ADSB_OUT_CFG -"+" ICAO:"+ICAO+" stallSpeed:"+stallSpeed+" callsign:"+callsign+" emitterType:"+emitterType+" aircraftSize:"+aircraftSize+" gpsOffsetLat:"+gpsOffsetLat+" gpsOffsetLon:"+gpsOffsetLon+" rfSelect:"+rfSelect+"";
    }
}
