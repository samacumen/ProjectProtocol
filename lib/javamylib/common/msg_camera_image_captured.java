...
public class msg_camera_image_captured extends MAVLinkMessage{
    ...
    */
    public byte file_path[] = new byte[210];
    ...
    */
    public MAVLinkPacket pack(){
        ...
        for (int i = 0; i < file_path.length; i++) {
            packet.payload.putByte(file_path[i]);
        }
    ...
    */
    public void unpack(MAVLinkPayload payload) {
        ...
        for (int i = 0; i < this.file_path.length; i++) {
            this.file_path[i] = payload.getByte();
        }
    ...
    */
    public void setFile_Path(String str) {
        int len = Math.min(str.length(), 210);
        for (int i=0; i<len; i++) {
            file_path[i] = (byte) str.charAt(i);
        }

        for (int i=len; i<210; i++) {            // padding for the rest of the buffer
            file_path[i] = 0;
        }
    }
    ...
    */
    public String getFile_Path() {
        ...
        for (int i = 0; i < 210; i++) {
            if (file_path[i] != 0)
                result = result + (char) file_path[i];
            else
                break;
        }
        return result;
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_CAMERA_IMAGE_CAPTURED -"+" time_utc:"+time_utc+" time_boot_ms:"+time_boot_ms+" lat:"+lat+" lon:"+lon+" alt:"+alt+" relative_alt:"+relative_alt+" q:"+q+" camera_id:"+camera_id+" file_path:"+file_path+"";
    }
}
