...
public class msg_device_op_write extends MAVLinkMessage{
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_DEVICE_OP_WRITE -"+" request_id:"+request_id+" target_system:"+target_system+" target_component:"+target_component+" bustype:"+bustype+" bus:"+bus+" address:"+address+" busname:"+busname+" regstart:"+regstart+" count:"+count+" data:"+data+"";
    }
}
