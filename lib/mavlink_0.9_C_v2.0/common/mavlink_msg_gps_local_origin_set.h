...
#define MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_MIN_LEN 12
						       ...
						       int32_t latitude, int32_t longitude, int32_t altitude)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_MIN_LEN, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_LEN, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_CRC);
}
						           ...
						           int32_t latitude,int32_t longitude,int32_t altitude)
{
	...
	msg->msgid = MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_MIN_LEN, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_LEN, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_CRC);
}
...
static inline void mavlink_msg_gps_local_origin_set_send(mavlink_channel_t chan, int32_t latitude, int32_t longitude, int32_t altitude)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET, buf, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_MIN_LEN, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_LEN, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_CRC);
#else
	mavlink_gps_local_origin_set_t packet;
	packet.latitude = latitude;
	packet.longitude = longitude;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET, (const char *)&packet, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_MIN_LEN, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_LEN, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_gps_local_origin_set_send_struct(mavlink_channel_t chan, const mavlink_gps_local_origin_set_t* gps_local_origin_set)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_gps_local_origin_set_send(chan, gps_local_origin_set->latitude, gps_local_origin_set->longitude, gps_local_origin_set->altitude);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET, (const char *)gps_local_origin_set, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_MIN_LEN, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_LEN, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_LEN? msg->len : MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_LEN;
        memset(gps_local_origin_set, 0, MAVLINK_MSG_ID_GPS_LOCAL_ORIGIN_SET_LEN);
	memcpy(gps_local_origin_set, _MAV_PAYLOAD(msg), len);
#endif
}
