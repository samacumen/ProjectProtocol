...
#define MAVLINK_MSG_ID_GPS_RAW_MIN_LEN 37
#define MAVLINK_MSG_ID_32_LEN 37
#define MAVLINK_MSG_ID_32_MIN_LEN 37
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_gps_raw_send(chan, gps_raw->usec, gps_raw->fix_type, gps_raw->lat, gps_raw->lon, gps_raw->alt, gps_raw->eph, gps_raw->epv, gps_raw->v, gps_raw->hdg);
#else
