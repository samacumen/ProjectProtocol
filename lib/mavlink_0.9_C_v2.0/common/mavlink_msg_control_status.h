...
#define MAVLINK_MSG_ID_CONTROL_STATUS_MIN_LEN 8
#define MAVLINK_MSG_ID_52_LEN 8
#define MAVLINK_MSG_ID_52_MIN_LEN 8

#define MAVLINK_MSG_ID_CONTROL_STATUS_CRC 157
#define MAVLINK_MSG_ID_52_CRC 157
...
{
	return mavlink_msg_control_status_pack_chan(system_id, component_id, chan, msg, control_status->position_fix, control_status->vision_fix, control_status->gps_fix, control_status->ahrs_health, control_status->control_att, control_status->control_pos_xy, control_status->control_pos_z, control_status->control_pos_yaw);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_control_status_send(chan, control_status->position_fix, control_status->vision_fix, control_status->gps_fix, control_status->ahrs_health, control_status->control_att, control_status->control_pos_xy, control_status->control_pos_z, control_status->control_pos_yaw);
#else
 ...
 */
static inline void mavlink_msg_control_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t position_fix, uint8_t vision_fix, uint8_t gps_fix, uint8_t ahrs_health, uint8_t control_att, uint8_t control_pos_xy, uint8_t control_pos_z, uint8_t control_pos_yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
