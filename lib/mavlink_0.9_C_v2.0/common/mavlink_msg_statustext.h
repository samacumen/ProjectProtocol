...
#define MAVLINK_MSG_ID_254_MIN_LEN 51

#define MAVLINK_MSG_ID_STATUSTEXT_CRC 106
#define MAVLINK_MSG_ID_254_CRC 106
 ...
 */
static inline void mavlink_msg_statustext_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t severity, const int8_t *text)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
