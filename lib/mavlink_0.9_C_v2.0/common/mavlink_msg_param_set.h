...
#define MAVLINK_MSG_ID_PARAM_SET_MIN_LEN 21
#define MAVLINK_MSG_ID_23_LEN 21
#define MAVLINK_MSG_ID_23_MIN_LEN 21

#define MAVLINK_MSG_ID_PARAM_SET_CRC 244
...
#define MAVLINK_MESSAGE_INFO_PARAM_SET { \
	...
	{  { "param_value", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_param_set_t, param_value) }, \
         ...
         { "param_id", NULL, MAVLINK_TYPE_INT8_T, 15, 6, offsetof(mavlink_param_set_t, param_id) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_SET { \
						       ...
						       uint8_t target_system, uint8_t target_component, const int8_t *param_id, float param_value)
{
	...
	_mav_put_int8_t_array(buf, 6, param_id, 15);
...
{
	return mavlink_msg_param_set_pack_chan(system_id, component_id, chan, msg, param_set->target_system, param_set->target_component, param_set->param_id, param_set->param_value);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_set_send(chan, param_set->target_system, param_set->target_component, param_set->param_id, param_set->param_value);
#else
 ...
 */
static inline void mavlink_msg_param_set_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, const int8_t *param_id, float param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
	return _MAV_RETURN_int8_t_array(msg, param_id, 15,  6);
}
