...
#define MAVLINK_MSG_ID_SET_NAV_MODE_MIN_LEN 2
						       ...
						       uint8_t target, uint8_t nav_mode)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_SET_NAV_MODE_MIN_LEN, MAVLINK_MSG_ID_SET_NAV_MODE_LEN, MAVLINK_MSG_ID_SET_NAV_MODE_CRC);
}
						           ...
						           uint8_t target,uint8_t nav_mode)
{
	...
	msg->msgid = MAVLINK_MSG_ID_SET_NAV_MODE;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SET_NAV_MODE_MIN_LEN, MAVLINK_MSG_ID_SET_NAV_MODE_LEN, MAVLINK_MSG_ID_SET_NAV_MODE_CRC);
}
...
static inline void mavlink_msg_set_nav_mode_send(mavlink_channel_t chan, uint8_t target, uint8_t nav_mode)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_NAV_MODE, buf, MAVLINK_MSG_ID_SET_NAV_MODE_MIN_LEN, MAVLINK_MSG_ID_SET_NAV_MODE_LEN, MAVLINK_MSG_ID_SET_NAV_MODE_CRC);
#else
	mavlink_set_nav_mode_t packet;
	packet.target = target;
	packet.nav_mode = nav_mode;

    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_NAV_MODE, (const char *)&packet, MAVLINK_MSG_ID_SET_NAV_MODE_MIN_LEN, MAVLINK_MSG_ID_SET_NAV_MODE_LEN, MAVLINK_MSG_ID_SET_NAV_MODE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_set_nav_mode_send_struct(mavlink_channel_t chan, const mavlink_set_nav_mode_t* set_nav_mode)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_set_nav_mode_send(chan, set_nav_mode->target, set_nav_mode->nav_mode);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_NAV_MODE, (const char *)set_nav_mode, MAVLINK_MSG_ID_SET_NAV_MODE_MIN_LEN, MAVLINK_MSG_ID_SET_NAV_MODE_LEN, MAVLINK_MSG_ID_SET_NAV_MODE_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_SET_NAV_MODE_LEN? msg->len : MAVLINK_MSG_ID_SET_NAV_MODE_LEN;
        memset(set_nav_mode, 0, MAVLINK_MSG_ID_SET_NAV_MODE_LEN);
	memcpy(set_nav_mode, _MAV_PAYLOAD(msg), len);
#endif
}
