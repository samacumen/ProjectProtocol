...
#define MAVLINK_MSG_ID_WAYPOINT_ACK_MIN_LEN 3
						       ...
						       uint8_t target_system, uint8_t target_component, uint8_t type)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_WAYPOINT_ACK_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_ACK_LEN, MAVLINK_MSG_ID_WAYPOINT_ACK_CRC);
}
						           ...
						           uint8_t target_system,uint8_t target_component,uint8_t type)
{
	...
	msg->msgid = MAVLINK_MSG_ID_WAYPOINT_ACK;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_WAYPOINT_ACK_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_ACK_LEN, MAVLINK_MSG_ID_WAYPOINT_ACK_CRC);
}
...
static inline void mavlink_msg_waypoint_ack_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t type)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_ACK, buf, MAVLINK_MSG_ID_WAYPOINT_ACK_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_ACK_LEN, MAVLINK_MSG_ID_WAYPOINT_ACK_CRC);
#else
	mavlink_waypoint_ack_t packet;
	packet.target_system = target_system;
	packet.target_component = target_component;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_ACK, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_ACK_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_ACK_LEN, MAVLINK_MSG_ID_WAYPOINT_ACK_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_waypoint_ack_send_struct(mavlink_channel_t chan, const mavlink_waypoint_ack_t* waypoint_ack)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_waypoint_ack_send(chan, waypoint_ack->target_system, waypoint_ack->target_component, waypoint_ack->type);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_ACK, (const char *)waypoint_ack, MAVLINK_MSG_ID_WAYPOINT_ACK_MIN_LEN, MAVLINK_MSG_ID_WAYPOINT_ACK_LEN, MAVLINK_MSG_ID_WAYPOINT_ACK_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_WAYPOINT_ACK_LEN? msg->len : MAVLINK_MSG_ID_WAYPOINT_ACK_LEN;
        memset(waypoint_ack, 0, MAVLINK_MSG_ID_WAYPOINT_ACK_LEN);
	memcpy(waypoint_ack, _MAV_PAYLOAD(msg), len);
#endif
}
