...
#define MAVLINK_MSG_ID_NAMED_VALUE_INT_MIN_LEN 14
#define MAVLINK_MSG_ID_253_LEN 14
#define MAVLINK_MSG_ID_253_MIN_LEN 14

#define MAVLINK_MSG_ID_NAMED_VALUE_INT_CRC 63
#define MAVLINK_MSG_ID_253_CRC 63
...
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_INT { \
	...
	"NAMED_VALUE_INT", \
	2, \
	{  { "value", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_named_value_int_t, value) }, \
         { "name", NULL, MAVLINK_TYPE_CHAR, 10, 4, offsetof(mavlink_named_value_int_t, name) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_INT { \
...
{
	return mavlink_msg_named_value_int_pack_chan(system_id, component_id, chan, msg, named_value_int->name, named_value_int->value);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_named_value_int_send(chan, named_value_int->name, named_value_int->value);
#else
 ...
 */
static inline void mavlink_msg_named_value_int_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const char *name, int32_t value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
