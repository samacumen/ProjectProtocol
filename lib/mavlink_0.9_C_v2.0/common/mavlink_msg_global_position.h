...
#define MAVLINK_MSG_ID_GLOBAL_POSITION_MIN_LEN 32
#define MAVLINK_MSG_ID_33_LEN 32
#define MAVLINK_MSG_ID_33_MIN_LEN 32
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_global_position_send(chan, global_position->usec, global_position->lat, global_position->lon, global_position->alt, global_position->vx, global_position->vy, global_position->vz);
#else
