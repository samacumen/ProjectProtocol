...
#define MAVLINK_MSG_ID_COMMAND_ACK_MIN_LEN 8
#define MAVLINK_MSG_ID_76_LEN 8
#define MAVLINK_MSG_ID_76_MIN_LEN 8

#define MAVLINK_MSG_ID_COMMAND_ACK_CRC 8
#define MAVLINK_MSG_ID_76_CRC 8
 ...
 */
static inline void mavlink_msg_command_ack_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float command, float result)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
