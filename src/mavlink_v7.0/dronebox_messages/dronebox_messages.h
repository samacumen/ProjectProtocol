...
#define MAVLINK_MESSAGE_CRCS {{500, 212, 1, 0, 0, 0}, {501, 107, 1, 0, 0, 0}}
#endif
...
typedef enum DS_RECEIVED_CMD_ACK_TYPE
{
	...
	DS_RECEIVED_CMD_ACK_TYPE_FAILED=6, /*   | */
	DS_RECEIVED_CMD_ACK_TYPE_ENUM_END=7, /*  | */
...
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_DS_ACTUATOR_DO_ACTION, MAVLINK_MESSAGE_INFO_DS_RECEIVED_CMD_ACK}
